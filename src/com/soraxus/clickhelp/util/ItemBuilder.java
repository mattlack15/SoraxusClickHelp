...
//	}
	...
	public ItemBuilder(PotionType type, boolean extended, boolean upgraded, boolean splash){
		this.item = new Potion(type, upgraded ? 0 : 1, splash, extended).toItemStack(this.item != null ? this.item.getAmount() : 1);
	}
	...
	public ItemBuilder(Material m, int amount) {
		...
		if(!this.item.hasItemMeta())
			this.item.setItemMeta(Bukkit.getItemFactory().getItemMeta(m));
	}
